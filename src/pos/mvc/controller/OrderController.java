    ...
    public String placeOrder(Order order, List<OrderDetail>orderDetails) throws SQLException{
        ...
        try {
            ...
            if(preparedStatementForOrder.executeUpdate()>0){
                String orderDetailInsertQuery = "INSERT INTO orderdetail (order_id,item_id, qty, sub_total) VALUES(?,?,?,?,?)";
                
                boolean isOrderDetailsSaved = true;
                
                for (OrderDetail orderDetail : orderDetails) {
                    PreparedStatement preparedStatementForOrderDetail = connection.prepareStatement(orderInsertQuery);        
                    ...
                    preparedStatementForOrderDetail.setDouble(3,orderDetail.getUnitPrice()* orderDetail.getQty());
